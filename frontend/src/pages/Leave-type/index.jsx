...
import {
  LeaveTypeModalStateContext,
  LeaveTypeModalActionsContext,
...
export default function LeaveType() {
  ...
  const [modalState, modalActions] = useModal(resetForm);
  ...
  return (
    <>
      <LeaveTypeModalActionsContext.Provider value={modalActions}>
        <LeaveTypeModalStateContext.Provider value={modalState}>
        ...
        </LeaveTypeModalStateContext.Provider>
      </LeaveTypeModalActionsContext.Provider>
    </>
  );
}
